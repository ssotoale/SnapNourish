  ...
  return (
    <>
      ...
      {currLocation ? (
        ...
        <View style={styles.nourishdog}>
        <Image source={require('../assets/Nourish_dog.png')} style={{height: 50, width:50}} resizeMode="contain"/>
        </View>
        <View>
        <Image source={require('../assets/Circle.png')} style={{height: 50, width:50}} resizeMode="contain"/>
        <Image source={require('../assets/Search.png')} style={{height: 50, width:50}} resizeMode="contain"/>
        </View>
        <View>
        <Image source={require('../assets/Nourish_Stories.png')} style={{height: 200, width:200}} resizeMode="contain"/>
        </View>
        <View>
        <Image source={require('../assets/Circle.png')} style={{height: 50, width:50}} resizeMode="contain"/>
        <Image source={require('../assets/Gear.png')} style={{height: 50, width:50}} resizeMode="contain"/>
        </View>
        <View>
